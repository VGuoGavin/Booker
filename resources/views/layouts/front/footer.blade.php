        ...
        <div class="row">
            ...
            <div class="col-6 col-md-2">
                ...
                <ul class="list-unstyled text-small">
                    <li><a class="text-muted" href="{{ route('front.index') }}">Home</a></li>
                    <li><a class="text-muted" href="{{ route('front.about') }}">About</a></li>
                </ul>
            </div>
            <div class="col-6 col-md-2">
                <h5>Support</h5>
                <ul class="list-unstyled text-small">
                    <li><a class="text-muted" href="{{ route('front.faq') }}">FAQ</a></li>
                    <li><a class="text-muted" href="{{ route('front.contact') }}">Contact</a></li>
                </ul>
            </div>
            <div class="col-6 col-md-2">
                <h5>Account</h5>
